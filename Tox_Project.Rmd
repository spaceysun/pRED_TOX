...
```{r echo=FALSE, message=FALSE, warning=FALSE, comment='', fig.width=9, fig.height=6, dev='png'}
bw_main_chart_facet
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, comment='', fig.width=10, fig.height=3, dev='png'}
bwg_main_chart_facet
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, comment='', fig.width=8, fig.height=16, dev='png'}
cp_main_comp_facet
```
